...
/**
 * Strategy implementation for card payments.
 * Handles Stripe or other card-based payment processing.
 */
@Slf4j
@Component
...
public class CardPaymentStrategy implements PaymentStrategy {
    ...
    public Payment createPayment(String appointmentId, BigDecimal amount, PaymentContext context) {
        log.info("Creating card payment for appointment: {}", appointmentId);
